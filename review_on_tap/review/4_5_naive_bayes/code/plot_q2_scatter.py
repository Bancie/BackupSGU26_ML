#!/usr/bin/env python3
"""Vẽ scatter nhiệt độ--độ ẩm (Câu 4.5.3), lưu PDF cho LaTeX."""
...
def main() -> None:
    ...
    plt.ylabel("Humidity (\\%)")
    plt.title("Câu 4.5.3 --- tennis (số), mẫu kiểm tra đánh dấu sao")
    plt.legend(loc="upper right", fontsize=9)
    plt.grid(True, alpha=0.3)
    out = FIG_DIR / "q_4_5_3_temp_humidity_scatter.pdf"
    plt.tight_layout()
