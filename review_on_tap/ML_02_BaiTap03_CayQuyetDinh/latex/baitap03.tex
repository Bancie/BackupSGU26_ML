...
\begin{center}
\includegraphics[width=0.96\textwidth]{figures/tree_muas_entropy.pdf}\\[4pt]
\small\textit{Minh họa cấu trúc cây theo entropy; trên \(12\) mẫu này Gini và lỗi phân loại cũng cho cùng cấu trúc (mục (c)).}
\end{center}
...
\begin{center}
\includegraphics[width=0.96\textwidth]{figures/tree_la_gini.pdf}\\[4pt]
\small\textit{Minh họa cây theo Gini; entropy và lỗi phân loại cho cấu trúc giống hệt trên bộ huấn luyện (mục (f)).}
\end{center}
...
\begin{center}
\includegraphics[width=0.96\textwidth]{figures/tree_vay_error.pdf}\\[4pt]
\small\textit{Minh họa theo lỗi phân loại ở gốc; Gini và entropy cũng thu được cùng cấu trúc như trong mục (c).}
\end{center}
